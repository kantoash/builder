...
export const addOnProducts = [
  { title: 'Priority Support', id: 'prod_Pid5LzNH2nHQ6R' },
]
...
export type EditorBtns =
  ...
  // pricing 
  // 1299 rupess Basic
  // 2199 rupess Unlimited Saas
  // 8199 rupess Priority Support
export const pricingCards = [
    ...
    },
    {
      ...
      priceId: 'price_1Ot8eoSGUvoljSz7Fb0invxy',
      href: '/agency?plan=Unlimited Saas'
    },
    {
      title: 'Basic',
      ...
      priceId: 'price_1Ot8eMSGUvoljSz7x3cVBHUq',
      href: '/agency?plan=Basic'
    },
  ]
  export const icons = [
    {
