...
import { ClipboardIcon, Contact2, DollarSign, Goal, IndianRupee, ShoppingCart } from 'lucide-react';
...
const Page = async ({ params, searchParams }:Props) => {
  ...
  const endDate = new Date(`${currentYear}-12-31T23:59:59Z`).getTime() / 100
